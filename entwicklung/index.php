    ...
    <body>
        ...
        <div class="components">
            <div class="col-md-4 col-lg-4 col-sm-12">
                <img src="../medien/entwicklungbilder/Raspberry.png" class="img-responsive" alt="Bild">
                <h3>Raspberry Pi</h3>
            ...
            <div class="col-md-4 col-lg-4 col-sm-12">
                <img src="../medien/entwicklungbilder/Kamera.jpg" class="img-responsive" alt="Bild">
                <h3>Kamera</h3>
            ...
            <div class="col-md-4 col-lg-4 col-sm-12">
                <img src="../medien/entwicklungbilder/StepDown.jpg" class="img-responsive" alt="Bild">
                <h3>Step-Downs</h3>
            ...
            <div class="col-md-4 col-lg-4 col-sm-12">
                <img src="../medien/entwicklungbilder/aakku.png" class="img-responsive" alt="Bild">
            ...
            <div class="col-md-4 col-lg-4 col-sm-12">
                <img src="../medien/entwicklungbilder/reifen.jpg" class="img-responsive" alt="Bild">
                <h3>Reifen</h3>
            ...
            <div class="col-md-4 col-lg-4 col-sm-12">
                <img src="../medien/entwicklungbilder/frontlicht.png" class="img-responsive" alt="Bild">
                <h3>Frontlicht</h3>
            ...
            <div class="col-md-4 col-lg-4 col-sm-12">
                <img src="../medien/entwicklungbilder/lichter.png" class="img-responsive" alt="Bild">
            ...
            <div class="col-md-4 col-lg-4 col-sm-12">
                <img src="../medien/entwicklungbilder/ddriver.png" class="img-responsive" alt="Bild">
            ...
            <div class="col-md-4 col-lg-4 col-sm-12">
                <img src="../medien/entwicklungbilder/motor.jpeg" class="img-responsive" alt="Bild">
                <h3>Motoren</h3>
            ...
            <div class="col-md-4 col-lg-4 col-sm-12">
                <img src="../medien/entwicklungbilder/ultrasonic.png" class="img-responsive" alt="Bild">
            ...
            <div class="col-md-4 col-lg-4 col-sm-12">
                <img src="../medien/entwicklungbilder/fotoresistor.png" class="img-responsive" alt="Bild">
                <h3>Fotoresistor</h3>
            ...
            <div class="col-md-4 col-lg-4 col-sm-12">
                <img src="../medien/entwicklungbilder/farbsensor.png" class="img-responsive" alt="Bild">
                <h3>Farbsensor</h3>
