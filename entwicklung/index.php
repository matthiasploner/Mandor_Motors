    ...
    <body>
        ...
        <div class="slideshow-container-1">
            <div class="slide-1 blueprint">
                <img src="../medien/entwicklungbilder/tomplan.png" class="img-responsive" alt="Bild">
                <p>Erste Skizze des Bauplanes vom MK1</p>
            </div>
            <div class="slide-1 blueprint">
                <img src="../medien/entwicklungbilder/bauplan.png" class="img-responsive" alt="Bild">
                <p>Bauplan und 3d Modell des MK1</p>
            </div>
            <div class="slide-1 blueprint">
                <img src="../medien/entwicklungbilder/firstlook.jpg" class="img-responsive" alt="Bild">
                <p>MK1 auf der Teststrecke</p>
            </div>
            <div class="slide-1 blueprint">
                <img src="../medien/entwicklungbilder/proto2.jpg" class="img-responsive" alt="Bild">
                <p>MK2 mit neuen Mecanum-Wheels auf der Teststrecke</p>
            </div>
            <div class="slide-1 blueprint">
                <img src="../medien/entwicklungbilder/MK3.jpg" class="img-responsive" alt="Bild">
                <p>MK3 mit neuen Sensoren auf der Teststrecke</p>
            </div>
            <div class="slide-1 blueprint">
                <img src="../medien/entwicklungbilder/MK3front.jpg" class="img-responsive" alt="Bild">
        ...
        <div class="components">
            <div class="col-md-4 col-lg-4 col-sm-12">
                <img src="../medien/entwicklungbilder/Raspberry.png" loading="lazy" class="img-responsive" alt="Bild">
                <h3>Raspberry Pi</h3>
            ...
            <div class="col-md-4 col-lg-4 col-sm-12">
                <img src="../medien/entwicklungbilder/Kamera.jpg"loading="lazy" class="img-responsive" alt="Bild">
                <h3>Kamera</h3>
            ...
            <div class="col-md-4 col-lg-4 col-sm-12">
                <img src="../medien/entwicklungbilder/StepDown.jpg"loading="lazy" class="img-responsive" alt="Bild">
                <h3>Step-Downs</h3>
            ...
            <div class="col-md-4 col-lg-4 col-sm-12">
                <img src="../medien/entwicklungbilder/aakku.png"loading="lazy" class="img-responsive" alt="Bild">
            ...
            <div class="col-md-4 col-lg-4 col-sm-12">
                <img src="../medien/entwicklungbilder/reifen.jpg"loading="lazy" class="img-responsive" alt="Bild">
                <h3>Reifen</h3>
            ...
            <div class="col-md-4 col-lg-4 col-sm-12">
                <img src="../medien/entwicklungbilder/frontlicht.png"loading="lazy" class="img-responsive" alt="Bild">
                <h3>Frontlicht</h3>
            ...
            <div class="col-md-4 col-lg-4 col-sm-12">
                <img src="../medien/entwicklungbilder/lichter.png"loading="lazy" class="img-responsive" alt="Bild">
            ...
            <div class="col-md-4 col-lg-4 col-sm-12">
                <img src="../medien/entwicklungbilder/ddriver.png"loading="lazy" class="img-responsive" alt="Bild">
            ...
            <div class="col-md-4 col-lg-4 col-sm-12">
                <img src="../medien/entwicklungbilder/motor.jpeg"loading="lazy" class="img-responsive" alt="Bild">
                <h3>Motoren</h3>
            ...
            <div class="col-md-4 col-lg-4 col-sm-12">
                <img src="../medien/entwicklungbilder/ultrasonic.png"loading="lazy" class="img-responsive" alt="Bild">
            ...
            <div class="col-md-4 col-lg-4 col-sm-12">
                <img src="../medien/entwicklungbilder/fotoresistor.png"loading="lazy" class="img-responsive" alt="Bild">
                <h3>Fotoresistor</h3>
            ...
            <div class="col-md-4 col-lg-4 col-sm-12">
                <img src="../medien/entwicklungbilder/farbsensor.png"loading="lazy" class="img-responsive" alt="Bild">
                <h3>Farbsensor</h3>
