    ...
    <body>
        ...
        <div class="personenmain">
            <div class="col-md-12 col-lg-11 col-sm-12 col-md-offset-1" >
                <img src="../medien/aboutusbilder/the_team.jpg" class="img-responsive" alt="Matthias Plaickner">
                <br><br>
            </div>
        </div>
            <div class="personen">
                <div class="col-md-4 col-lg-4 col-sm-12">
                    <img src="../medien/aboutusbilder/Matthias_Plaickner.jpg" class="img-responsive" alt="Matthias Plaickner">
                    ...
                    <h4><b>Telefon: <a href="tel:+393496289729">+39 349 628 9729</a></b></h4>
                </div>
                <div class="col-md-4 col-lg-4 col-sm-12">
                    <img src="../medien/aboutusbilder/Simon_Ploner.jpg" class="img-responsive" alt="Matthias Plaickner">
                    ...
                    <h4><b>Telefon: <a href="tel:+393427678341">+39 342 767 8341</a></b></h4>
                </div>
                <div class="col-md-4 col-lg-4 col-sm-12">
                    <img src="../medien/aboutusbilder/Matthias_Ploner.jpg" class="img-responsive" alt="Matthias Plaickner">
                    ...
                    <h4><b>Telefon: <a href="tel:+393924094441">+39 392 409 4441</a></b></h4>
                    <br>
                </div>
                <div class="col-lg-offset-1 col-md-offset-1 col-md-4 col-lg-4 col-sm-12">
                    <img src="../medien/aboutusbilder/Michael_Huberr.jpg" class="img-responsive" alt="Matthias Plaickner">
                    ...
                    <h4><b>Telefon: <a href="tel:+393283888854">+39 328 388 8854</a></b></h4>
                </div>
                <div class="col-lg-offset-2 col-md-4 col-lg-4 col-sm-12">
                    <img src="../medien/aboutusbilder/Thomas_Reinthaler.jpg" class="img-responsive" alt="Matthias Plaickner">
                    ...
                    <h4><b>Telefon: <a href="tel:+393456840123">+39 345 684 0123</a></b></h4>
                </div>
        </div>
