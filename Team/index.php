    ...
    <body>
        ...
        <div class="personenmain">
            <div class="col-md-12 col-lg-11 col-sm-12 col-md-offset-1" >
                <img src="../medien/aboutusbilder/the_team.jpg" class="img-responsive" alt="Team">
                <br><br>
            </div>
        </div>
            <div class="personen">
                ...
                <div class="col-md-4 col-lg-4 col-sm-12">
                    <img src="../medien/aboutusbilder/Simon_Ploner.jpg" class="img-responsive" alt="Simon Ploner">
                ...
                <div class="col-md-4 col-lg-4 col-sm-12">
                    <img src="../medien/aboutusbilder/Matthias_Ploner.jpg" class="img-responsive" alt="Matthias Ploner">
                ...
                <div class="col-lg-offset-1 col-md-offset-1 col-md-4 col-lg-4 col-sm-12">
                    <img src="../medien/aboutusbilder/Michael_Huberr.jpg" class="img-responsive" alt="Micheal Huber">
                ...
                <div class="col-lg-offset-2 col-md-4 col-lg-4 col-sm-12">
                    <img src="../medien/aboutusbilder/Thomas_Reinthaler.jpg" class="img-responsive" alt="Thomas Reinthaler">
